...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws Exception {
        ...
        question.setQuestionIcon("UPyyXyxu522rHZLZM4qQJNhpbjTs3G94zrKfYEEvH9LR0AV9E8");
        question.setLevelid(6);
        question.setQuestionDetails("DLlowffaap");
        question.setQuestion("VB2j7iyfDjnBmZ94DsXrxDfGqrmlSE8RLglvK9SJgNcn8GPt4o");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionIcon("pURQeHtvZjMnvqgSYcmoyaKI8C9BFjGG3J24fL4L2QVrDJ8QXB");
            question.setLevelid(10);
            question.setQuestionDetails("I5BAOpPk5k");
            question.setQuestion("uUgnJ6hRPTWOWW9jYceTEmsP9dcl8fXEhoiXwPCIAJeOTJfxLE");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 2, "levelid", 22));
        entityConstraints.add(new EntityTestCriteria(NOT_NULL, 3, "question", null));
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityConstraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "IIwlhT3NjZZjUhXf5WKlirBe0CtRvu9HWxl7P15redCf8T1Mp8t8ZYQbTw647T1lK"));
