Ext.define('Project3.project3.web.projectthree.controller.organization.contactmanagement.CoreContactsMainController', {
     ...
     setGridConfig: function(data) {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Project3.project3.shared.projectthree.model.organization.contactmanagement.CoreContactsModel',
               autoLoad: true,
