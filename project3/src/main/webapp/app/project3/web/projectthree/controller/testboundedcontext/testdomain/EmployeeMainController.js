Ext.define('Project3.project3.web.projectthree.controller.testboundedcontext.testdomain.EmployeeMainController', {
     ...
     setGridConfig: function(data) {
          ...
          var gridStore = Ext.create('Ext.data.Store', {
               model: 'Project3.project3.shared.projectthree.model.testboundedcontext.testdomain.EmployeeModel',
               autoLoad: true,
