...
public class Employee implements Serializable, CommonEntityInterface, Comparator<Employee> {
    ...
    private static final long serialVersionUID = 1471937011051L;
    ...
    public boolean equals(Object obj) {
        try {
            projectthree.app.shared.testboundedcontext.testdomain.Employee other = (projectthree.app.shared.testboundedcontext.testdomain.Employee) obj;
            if (empId == null) {
                return false;
