...
@Table(name = "ast_Bug_T")
@Entity
@Cache(type = CacheType.CACHE)
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "11", comments = "Bug", complexity = Complexity.LOW)
...
public class Bug implements Serializable, CommonEntityInterface, Comparator<Bug> {
    ...
    private static final long serialVersionUID = 1471943840390L;
    ...
    @Column(name = "bugComponent")
    @JsonProperty("bugComponent")
    @NotNull
    @Size(min = 1, max = 256)
    private String bugComponent;

    @Column(name = "bugPriority")
    @JsonProperty("bugPriority")
    @Size(min = 1, max = 256)
    ...
    public String getBugComponent() {
        return bugComponent;
    }

    public void setBugComponent(String _bugComponent) {
        if (_bugComponent != null) {
            this.bugComponent = _bugComponent;
        }
    }
    ...
    public void setBugPriority(String _bugPriority) {
        this.bugPriority = _bugPriority;
    }
    ...
    public String getPrimaryDisplay() {
        ...
        sb.append((bugName == null ? " " : bugName) + ",").append((bugComponent == null ? " " : bugComponent));
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        try {
            projectthree.app.shared.testboundedcontext.testdomain.Bug other = (projectthree.app.shared.testboundedcontext.testdomain.Bug) obj;
            if (bugId == null) {
                return false;
