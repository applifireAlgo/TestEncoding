...
public class Login implements Serializable, CommonEntityInterface, UserAuthentication, Comparator<Login> {
    ...
    private static final long serialVersionUID = 1471935874256L;
    ...
    public boolean equals(Object obj) {
        try {
            projectthree.app.shared.appbasicsetup.usermanagement.Login other = (projectthree.app.shared.appbasicsetup.usermanagement.Login) obj;
            if (loginPk == null) {
                return false;
