package projectthree.app.shared.appbasicsetup.userrolemanagement;
...
public class Roles implements Serializable, CommonEntityInterface, Comparator<Roles> {
    ...
    private static final long serialVersionUID = 1471935878095L;
    ...
    public Roles addRoleMenuBridge(RoleMenuBridge _roleMenuBridge) {
        if (this.roleMenuBridge == null) {
            this.roleMenuBridge = new java.util.ArrayList<projectthree.app.shared.appbasicsetup.userrolemanagement.RoleMenuBridge>();
        }
    ...
    public boolean equals(Object obj) {
        try {
            projectthree.app.shared.appbasicsetup.userrolemanagement.Roles other = (projectthree.app.shared.appbasicsetup.userrolemanagement.Roles) obj;
            if (roleId == null) {
                return false;
