...
public class SessionData implements Serializable, CommonEntityInterface, SessionDataInterface, Comparator<SessionData> {
    ...
    private static final long serialVersionUID = 1471935877740L;
    ...
    public boolean equals(Object obj) {
        try {
            projectthree.app.shared.appbasicsetup.usermanagement.SessionData other = (projectthree.app.shared.appbasicsetup.usermanagement.SessionData) obj;
            if (dataId == null) {
                return false;
