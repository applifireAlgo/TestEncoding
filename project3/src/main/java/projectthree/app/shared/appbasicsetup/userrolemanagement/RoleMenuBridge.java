...
public class RoleMenuBridge implements Serializable, CommonEntityInterface, Comparator<RoleMenuBridge> {
    ...
    private static final long serialVersionUID = 1471935879686L;
    ...
    public boolean equals(Object obj) {
        try {
            projectthree.app.shared.appbasicsetup.userrolemanagement.RoleMenuBridge other = (projectthree.app.shared.appbasicsetup.userrolemanagement.RoleMenuBridge) obj;
            if (roleMenuMapId == null) {
                return false;
