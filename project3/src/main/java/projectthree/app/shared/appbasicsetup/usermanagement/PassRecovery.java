...
public class PassRecovery implements Serializable, CommonEntityInterface, PassRecoveryInterface, Comparator<PassRecovery> {
    ...
    private static final long serialVersionUID = 1471935877022L;
    ...
    public boolean equals(Object obj) {
        try {
            projectthree.app.shared.appbasicsetup.usermanagement.PassRecovery other = (projectthree.app.shared.appbasicsetup.usermanagement.PassRecovery) obj;
            if (passRecoveryId == null) {
                return false;
