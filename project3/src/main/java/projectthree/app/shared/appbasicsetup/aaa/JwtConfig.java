...
public class JwtConfig implements Serializable, CommonEntityInterface, Comparator<JwtConfig> {
    ...
    private static final long serialVersionUID = 1471935881139L;
    ...
    public boolean equals(Object obj) {
        try {
            projectthree.app.shared.appbasicsetup.aaa.JwtConfig other = (projectthree.app.shared.appbasicsetup.aaa.JwtConfig) obj;
            if (configId == null) {
                return false;
