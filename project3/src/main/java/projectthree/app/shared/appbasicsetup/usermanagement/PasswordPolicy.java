...
public class PasswordPolicy implements Serializable, CommonEntityInterface, PasswordPolicyInterface, Comparator<PasswordPolicy> {
    ...
    private static final long serialVersionUID = 1471935868402L;
    ...
    public boolean equals(Object obj) {
        try {
            projectthree.app.shared.appbasicsetup.usermanagement.PasswordPolicy other = (projectthree.app.shared.appbasicsetup.usermanagement.PasswordPolicy) obj;
            if (policyId == null) {
                return false;
