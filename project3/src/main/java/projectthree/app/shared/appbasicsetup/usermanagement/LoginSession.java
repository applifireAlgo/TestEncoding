...
public class LoginSession implements Serializable, CommonEntityInterface, LoginSessionInterface, Comparator<LoginSession> {
    ...
    private static final long serialVersionUID = 1471935876876L;
    ...
    public boolean equals(Object obj) {
        try {
            projectthree.app.shared.appbasicsetup.usermanagement.LoginSession other = (projectthree.app.shared.appbasicsetup.usermanagement.LoginSession) obj;
            if (appSessionId == null) {
                return false;
