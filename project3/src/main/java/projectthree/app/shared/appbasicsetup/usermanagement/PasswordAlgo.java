...
public class PasswordAlgo implements Serializable, CommonEntityInterface, PasswordAlgoInterface, Comparator<PasswordAlgo> {
    ...
    private static final long serialVersionUID = 1471935867762L;
    ...
    public boolean equals(Object obj) {
        try {
            projectthree.app.shared.appbasicsetup.usermanagement.PasswordAlgo other = (projectthree.app.shared.appbasicsetup.usermanagement.PasswordAlgo) obj;
            if (algoId == null) {
                return false;
