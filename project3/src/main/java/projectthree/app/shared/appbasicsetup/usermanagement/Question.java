...
public class Question implements Serializable, CommonEntityInterface, Comparator<Question> {
    ...
    private static final long serialVersionUID = 1471935868956L;
    ...
    public boolean equals(Object obj) {
        try {
            projectthree.app.shared.appbasicsetup.usermanagement.Question other = (projectthree.app.shared.appbasicsetup.usermanagement.Question) obj;
            if (questionId == null) {
                return false;
