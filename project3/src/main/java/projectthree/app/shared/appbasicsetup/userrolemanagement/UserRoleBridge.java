...
public class UserRoleBridge implements Serializable, CommonEntityInterface, Comparator<UserRoleBridge> {
    ...
    private static final long serialVersionUID = 1471935880121L;
    ...
    public boolean equals(Object obj) {
        try {
            projectthree.app.shared.appbasicsetup.userrolemanagement.UserRoleBridge other = (projectthree.app.shared.appbasicsetup.userrolemanagement.UserRoleBridge) obj;
            if (roleUserMapId == null) {
                return false;
