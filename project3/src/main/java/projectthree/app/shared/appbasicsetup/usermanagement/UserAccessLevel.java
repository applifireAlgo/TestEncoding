...
public class UserAccessLevel implements Serializable, CommonEntityInterface, Comparator<UserAccessLevel> {
    ...
    private static final long serialVersionUID = 1471935869518L;
    ...
    public boolean equals(Object obj) {
        try {
            projectthree.app.shared.appbasicsetup.usermanagement.UserAccessLevel other = (projectthree.app.shared.appbasicsetup.usermanagement.UserAccessLevel) obj;
            if (userAccessLevelId == null) {
                return false;
