...
public class AppMenus implements Serializable, CommonEntityInterface, Comparator<AppMenus> {
    ...
    private static final long serialVersionUID = 1471935879277L;
    ...
    public boolean equals(Object obj) {
        try {
            projectthree.app.shared.appbasicsetup.userrolemanagement.AppMenus other = (projectthree.app.shared.appbasicsetup.userrolemanagement.AppMenus) obj;
            if (menuId == null) {
                return false;
