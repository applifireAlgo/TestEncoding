...
public class UserData implements Serializable, CommonEntityInterface, UserDataInterface, Comparator<UserData> {
    ...
    private static final long serialVersionUID = 1471935877332L;
    ...
    public boolean equals(Object obj) {
        try {
            projectthree.app.shared.appbasicsetup.usermanagement.UserData other = (projectthree.app.shared.appbasicsetup.usermanagement.UserData) obj;
            if (userDataId == null) {
                return false;
