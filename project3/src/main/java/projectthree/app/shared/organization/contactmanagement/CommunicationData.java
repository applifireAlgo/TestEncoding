...
public class CommunicationData implements Serializable, CommonEntityInterface, Comparator<CommunicationData> {
    ...
    private static final long serialVersionUID = 1471935867379L;
    ...
    public boolean equals(Object obj) {
        try {
            projectthree.app.shared.organization.contactmanagement.CommunicationData other = (projectthree.app.shared.organization.contactmanagement.CommunicationData) obj;
            if (commDataId == null) {
                return false;
