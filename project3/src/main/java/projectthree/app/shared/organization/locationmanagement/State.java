...
public class State implements Serializable, CommonEntityInterface, Comparator<State> {
    ...
    private static final long serialVersionUID = 1471935855495L;
    ...
    public boolean equals(Object obj) {
        try {
            projectthree.app.shared.organization.locationmanagement.State other = (projectthree.app.shared.organization.locationmanagement.State) obj;
            if (stateId == null) {
                return false;
