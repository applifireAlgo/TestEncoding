...
public class Language implements Serializable, CommonEntityInterface, Comparator<Language> {
    ...
    private static final long serialVersionUID = 1471935852818L;
    ...
    public boolean equals(Object obj) {
        try {
            projectthree.app.shared.organization.locationmanagement.Language other = (projectthree.app.shared.organization.locationmanagement.Language) obj;
            if (languageId == null) {
                return false;
