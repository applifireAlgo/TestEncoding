...
public class Timezone implements Serializable, CommonEntityInterface, TimeZoneInterface, Comparator<Timezone> {
    ...
    private static final long serialVersionUID = 1471935850940L;
    ...
    public boolean equals(Object obj) {
        try {
            projectthree.app.shared.organization.locationmanagement.Timezone other = (projectthree.app.shared.organization.locationmanagement.Timezone) obj;
            if (timeZoneId == null) {
                return false;
