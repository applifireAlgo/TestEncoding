...
public class CommunicationGroup implements Serializable, CommonEntityInterface, Comparator<CommunicationGroup> {
    ...
    private static final long serialVersionUID = 1471935859857L;
    ...
    public boolean equals(Object obj) {
        try {
            projectthree.app.shared.organization.contactmanagement.CommunicationGroup other = (projectthree.app.shared.organization.contactmanagement.CommunicationGroup) obj;
            if (commGroupId == null) {
                return false;
