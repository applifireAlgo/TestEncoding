...
public class CommunicationType implements Serializable, CommonEntityInterface, Comparator<CommunicationType> {
    ...
    private static final long serialVersionUID = 1471935860659L;
    ...
    public boolean equals(Object obj) {
        try {
            projectthree.app.shared.organization.contactmanagement.CommunicationType other = (projectthree.app.shared.organization.contactmanagement.CommunicationType) obj;
            if (commType == null) {
                return false;
