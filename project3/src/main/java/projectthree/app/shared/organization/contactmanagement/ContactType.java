...
public class ContactType implements Serializable, CommonEntityInterface, Comparator<ContactType> {
    ...
    private static final long serialVersionUID = 1471935859316L;
    ...
    public boolean equals(Object obj) {
        try {
            projectthree.app.shared.organization.contactmanagement.ContactType other = (projectthree.app.shared.organization.contactmanagement.ContactType) obj;
            if (contactTypeId == null) {
                return false;
