...
public class AddressType implements Serializable, CommonEntityInterface, Comparator<AddressType> {
    ...
    private static final long serialVersionUID = 1471935857667L;
    ...
    public boolean equals(Object obj) {
        try {
            projectthree.app.shared.organization.locationmanagement.AddressType other = (projectthree.app.shared.organization.locationmanagement.AddressType) obj;
            if (addressTypeId == null) {
                return false;
