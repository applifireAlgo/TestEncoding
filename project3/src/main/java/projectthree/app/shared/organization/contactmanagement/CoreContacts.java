package projectthree.app.shared.organization.contactmanagement;
...
public class CoreContacts implements Serializable, CommonEntityInterface, CoreContactsInterface, Comparator<CoreContacts> {
    ...
    private static final long serialVersionUID = 1471935864072L;
    ...
    public CoreContacts addCommunicationData(CommunicationData _communicationData) {
        if (this.communicationData == null) {
            this.communicationData = new java.util.ArrayList<projectthree.app.shared.organization.contactmanagement.CommunicationData>();
        }
    ...
    public CoreContacts addAddress(Address _address) {
        if (this.address == null) {
            this.address = new java.util.ArrayList<projectthree.app.shared.organization.locationmanagement.Address>();
        }
        if (_address != null) {
    ...
    public boolean equals(Object obj) {
        try {
            projectthree.app.shared.organization.contactmanagement.CoreContacts other = (projectthree.app.shared.organization.contactmanagement.CoreContacts) obj;
            if (contactId == null) {
                return false;
