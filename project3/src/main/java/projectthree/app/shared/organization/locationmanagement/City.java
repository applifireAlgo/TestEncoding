...
public class City implements Serializable, CommonEntityInterface, Comparator<City> {
    ...
    private static final long serialVersionUID = 1471935856622L;
    ...
    public boolean equals(Object obj) {
        try {
            projectthree.app.shared.organization.locationmanagement.City other = (projectthree.app.shared.organization.locationmanagement.City) obj;
            if (cityId == null) {
                return false;
