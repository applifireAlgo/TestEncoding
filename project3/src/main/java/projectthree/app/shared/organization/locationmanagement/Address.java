...
public class Address implements Serializable, CommonEntityInterface, Comparator<Address> {
    ...
    private static final long serialVersionUID = 1471935858410L;
    ...
    public boolean equals(Object obj) {
        try {
            projectthree.app.shared.organization.locationmanagement.Address other = (projectthree.app.shared.organization.locationmanagement.Address) obj;
            if (addressId == null) {
                return false;
