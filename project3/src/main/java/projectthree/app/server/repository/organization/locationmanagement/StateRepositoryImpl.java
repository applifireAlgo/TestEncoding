...
public class StateRepositoryImpl extends SearchInterfaceImpl implements StateRepository<State> {
    ...
    public void delete(String id) throws Exception {
        EntityManager emanager = emfResource.getResource();
        State object = emanager.find(projectthree.app.shared.organization.locationmanagement.State.class, id);
    ...
    public List<State> findByCountryId(String countryId) throws Exception {
        ...
        java.util.List<projectthree.app.shared.organization.locationmanagement.State> listOfState = query.getResultList();
