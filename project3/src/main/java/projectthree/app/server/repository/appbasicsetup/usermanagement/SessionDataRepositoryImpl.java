...
import projectthree.app.shared.appbasicsetup.usermanagement.SessionData;
...
public class SessionDataRepositoryImpl extends SearchInterfaceImpl implements SessionDataRepository<SessionData> {
    ...
    public void delete(String id) throws Exception {
        javax.persistence.EntityManager emanager = emfResource.getResource();
        projectthree.app.shared.appbasicsetup.usermanagement.SessionData s = emanager.find(projectthree.app.shared.appbasicsetup.usermanagement.SessionData.class, id);
        emanager.remove(s);
    }
