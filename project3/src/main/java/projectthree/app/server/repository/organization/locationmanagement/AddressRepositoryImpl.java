...
public class AddressRepositoryImpl extends SearchInterfaceImpl implements AddressRepository<Address> {
    ...
    public void delete(String id) throws Exception {
        EntityManager emanager = emfResource.getResource();
        Address object = emanager.find(projectthree.app.shared.organization.locationmanagement.Address.class, id);
    ...
    public List<Address> findByAddressTypeId(String addressTypeId) throws Exception {
        ...
        java.util.List<projectthree.app.shared.organization.locationmanagement.Address> listOfAddress = query.getResultList();
