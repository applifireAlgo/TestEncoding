...
public class LoginRepositoryImpl extends SearchInterfaceImpl implements LoginRepository<Login> {
    ...
    public void delete(String id) throws Exception {
        EntityManager emanager = emfResource.getResource();
        Login object = emanager.find(projectthree.app.shared.appbasicsetup.usermanagement.Login.class, id);
    ...
    public List<Login> findByContactId(String contactId) throws Exception {
        ...
        java.util.List<projectthree.app.shared.appbasicsetup.usermanagement.Login> listOfLogin = query.getResultList();
