...
public class CommunicationTypeRepositoryImpl extends SearchInterfaceImpl implements CommunicationTypeRepository<CommunicationType> {
    ...
    public void delete(String id) throws Exception {
        EntityManager emanager = emfResource.getResource();
        CommunicationType object = emanager.find(projectthree.app.shared.organization.contactmanagement.CommunicationType.class, id);
    ...
    public List<CommunicationType> findByCommGroupId(String commGroupId) throws Exception {
        ...
        java.util.List<projectthree.app.shared.organization.contactmanagement.CommunicationType> listOfCommunicationType = query.getResultList();
